...
export default function ProjectCard() {
  ...
  return (
    <React.Fragment>
      <div className="bg-primary py-2 h-[87vh] relative">
        {" "}
        ...
        <div className="flex flex-row pl-4 justify-between">
          ...
          <div>
            <button className="w-32 h-8 rounded-sm bg-blue-600 text-white text-sm font-semibold leading-4 text-center mr-4 py-2 px-6">
              Audit Now
            </button>
            <button className="w-32 h-8 rounded-sm text-blue-600 text-sm font-semibold mr-8 leading-4 relative py-2 px-6 bg-optionButton text-center">
              Options
              {notificationVisible && (
